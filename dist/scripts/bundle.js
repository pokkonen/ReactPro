...
const Header = React.createClass({displayName: "Header",
  render: () => {
    return (
      React.createElement("nav", {className: "navbar navbar-expand-lg navbar-light"}, 
        React.createElement("div", {className: "collapse navbar-collapse"}, 
          React.createElement("a", {href: "/", className: "navbar-brand"}, 
            React.createElement("img", {className: "w-25", src: "images/pluralsight-logo.png"})
          ), 
          React.createElement("ul", {className: "nav navbar-nav"}, 
            React.createElement("li", {className: "nav-item active"}, React.createElement("a", {className: "nav-link", href: "/"}, "Home")), 
            React.createElement("li", {className: "nav-item"}, React.createElement("a", {className: "nav-link", href: "/#about"}, "About"))
          )
        )
      )
    );
    ...
    return (
      React.createElement("div", {className: "jumbotron"}, 
        ...
        React.createElement("ul", null, 
          ...
          React.createElement("li", null, "Beer"), 
